...
var hunspellSupportMatrix = []hunspellSupportEntry{
	...
	{Directive: "COMPOUNDMIDDLE", Status: supportPartial, Notes: "compound middle flag supported for boundary checks"},
	...
	{Directive: "CHECKCOMPOUNDPATTERN", Status: supportSupported, Notes: "compound boundary checks and 3-field sandhi replacement forms supported, including condition flags arriving via affix continuation classes"},
