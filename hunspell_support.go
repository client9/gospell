...
var hunspellSupportMatrix = []hunspellSupportEntry{
	...
	{Directive: "COMPOUNDFLAG", Status: supportUnsupported, Notes: "compound flags not implemented"},
	{Directive: "COMPOUNDBEGIN", Status: supportUnsupported, Notes: "compound begin flag not implemented"},
	{Directive: "COMPOUNDMIDDLE", Status: supportUnsupported, Notes: "compound middle flag not implemented"},
	{Directive: "COMPOUNDEND", Status: supportUnsupported, Notes: "compound end flag not implemented"},
	...
	{Directive: "CHECKCOMPOUNDPATTERN", Status: supportUnsupported, Notes: "compound pattern checks not implemented"},
